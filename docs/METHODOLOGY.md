# Benchmark Methodology, Pre-Registered Failure Categories, and Full Results

This document preserves the full benchmark methodology and results. The
summary lives in the [main README](../README.md); corpus design rules live in
